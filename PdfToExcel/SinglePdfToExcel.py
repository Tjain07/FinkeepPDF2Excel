...
df = pd.DataFrame(all_data, columns=["Order No", "Order Time", "Trade No", "Trade Time", "Security / Contract/ISIN Description", "B/S", "Quantity", "Gross Rate/TradePrice PerUnit(inForeign Currency)(1)", "GrossRate/TradePricePerUnit(Rs)(2)","Brokerage PerUnit (Rs.)", "Net Rate PerUnit(Rs.)@", "ClosingRateDerivatives(Rs)", "GST", "STT", "Net TotalBeforeLevies(Rs.)", "Remarks", ])
